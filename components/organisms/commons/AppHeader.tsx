...
const AppHeader = () => {
  ...
  const clsHeaderDefault =
    'fixed w-full top-0 left-0 z-[10] lg:h-[78px] ';
  ...
  return (
    ...
    >
      {!expandingMenu ? (
        <div className="flex items-center justify-between w-full h-full lg:px-aa-xxl lg:py-aa-xl">
          <a href="/" className="font-cameraPlain">
            <Text cls="font-18x">AA</Text>
          </a>
        ...
        <div className="flex flex-col items-center w-full h-screen px-0 overflow-hidden bg-black lg:px-aa-xxxl lg:py-aa-xl">
